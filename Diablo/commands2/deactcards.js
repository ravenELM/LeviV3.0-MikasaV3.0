...
module.exports = {
  ...
  run: async (m, { conn }) => {
    ...
    if (list.includes(groupId)) {
      ...
      await conn.sendMessage(groupId, { text: '✅ This group has been deactivated for card spawns.' }, { quoted: m });
    } else {
      await conn.sendMessage(groupId, { text: '⚠️ This group is not activated.' }, { quoted: m });
    }
  }
};
